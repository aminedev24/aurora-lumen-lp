...
$servername = "localhost:3306"; // Your database host (e.g., 'localhost', '127.0.0.1')
$username = "yqjezvte_aurora-nexusartisbay"; // Your database username
$password = "NLmV%)&NvwO]"; // Your database password
$dbname = "yqjezvte_aurora-nexus"; // The name of your database
